...
import { Radio, Checkbox, Label } from 'react-bootstrap';
...
export default class Question extends React.Component {
  ...
  render() {
    ...
    return (
      <form>
        <p><Label bsStyle="success">1.您自己觉得容易疲劳或乏力吗？</Label></p>
        ...
        <p><Label bsStyle="success">2.您平时容易怕冷、怕热、或手足心热吗？</Label></p>
        ...
        <p><Label bsStyle="success">3.您平时容易出汗或晚上睡觉易出汗吗？</Label></p>
        ...
        <p><Label bsStyle="success">4.您平时小便怎么样？</Label></p>
        ...
        <p><Label bsStyle="success">5.您平时大便怎么样？</Label></p>
        ...
        <p><Label bsStyle="success">6.您平时胃口怎么样？</Label></p>
        ...
        <p><Label bsStyle="success">7.您平时容易口渴或口干吗？</Label></p>
        ...
        <p><Label bsStyle="success">8.您平时觉得口中有异样的味道吗？</Label></p>
        ...
        <p><Label bsStyle="success">9.您平时容易心烦、情绪低落吗？</Label></p>
        ...
        <p><Label bsStyle="success">10.您容易掉头发吗？</Label></p>
        ...
        <p><Label bsStyle="success">11.您平时容易失眠吗？</Label></p>
        ...
        <p><Label bsStyle="success">12.您平时身体有胀满不适吗？</Label></p>
        ...
        <p><Label bsStyle="success">13.您自己感觉腰膝酸软、腿脚无力吗？</Label></p>
